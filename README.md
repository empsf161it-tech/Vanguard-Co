# Vanguard & Partners | Luxury Legal Counsel Web Template

A high-performance, responsive luxury web application designed for law firms, legal consultants, and high-stakes trial advocacy practices. Built using pure advanced HTML5, CSS3, and JavaScript, featuring GSAP animations, light/dark theme switching, RTL (Right-To-Left) support, and bespoke legal practice modules.
...
- **13 Complete HTML Pages**:
  ...
  - `services.html`: Practice Areas (5 full-screen dedicated legal discipline sections: M&A, Trial Defense, IP, Private Wealth, Arbitration)
...
- **Dark & Light Mode Switcher**: `prefers-color-scheme` auto-detect with `localStorage` persistence and sun/moon icon toggle.
- **Strict Breakpoint Rules**: Full horizontal menu above 1024px; slide-out drawer menu with 44px+ touch-friendly links at <= 1024px.
- **Client-Side Form Validation**: Real-time error states, regex email format checks, password match validation, and inline alert feedback.
...
1. Open `index.html` in any web browser to view the application.
2. Toggle between Light Mode and Dark Mode using the moon/sun icon in the navbar (or inside the mobile drawer).
3. Toggle between LTR and RTL text direction using the ⇄ double-arrow button.
